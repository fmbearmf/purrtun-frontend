import { version, unref, inject, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Transition, useSSRContext, createApp, effectScope, reactive, hasInjectionContext, getCurrentInstance, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/vue@3.4.21/node_modules/vue/index.mjs';
...
import { sanitizeStatusCode, createError as createError$1 } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/h3@1.11.1/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/unhead@1.9.4/node_modules/unhead/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/vue-router@4.3.0_vue@3.4.21/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/bear/.app/purrtun-frontend/node_modules/.pnpm/vue@3.4.21/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C7WIycek.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DbYAhDQX.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BYJWZ-X6.mjs').then((r) => r.default || r));
...
export { On as O, _export_sfc as _, parseQuery as a, useRuntimeConfig as b, navigateTo as c, withoutTrailingSlash as d, entry$1 as default, br as e, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseURL as p, resolveUnrefHeadInput as r, useRouter as u, withTrailingSlash as w };
